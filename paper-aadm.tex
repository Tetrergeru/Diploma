...
{\small\rm \hfill Metagraph approach for construction of an (m, n)-regular bipartite graph with a given girth -header
\hfill}}
...
\footnotetext{\scriptsize ${}^{\ast}$Corresponding author. John Doe}
\footnotetext{\scriptsize 2020 Mathematics Subject Classification. FILL SUBJECT MSCs HERE.

\rule{2.4mm}{0mm}Keywords and Phrases. Fill Keywords and Phrases Here - at most 5, separated by commas.}}
